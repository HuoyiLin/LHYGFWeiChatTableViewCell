...
@interface TYYDemoVC ()<UITableViewDelegate,UITableViewDataSource>
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        cell = [[LHYGFWeiChatCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"LHYGFWeiChatCell"];
    }
